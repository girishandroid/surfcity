          	...
          	<div class="row match-height">
          		<div class="col-md-12">
          			<div class="card">
          				<div class="card-header">
          					<h4 class="card-title" id="basic-layout-form-center">Add Offer Menu Item</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						<form class="form" id="formAddOfferMenu" action="javascript:addOfferMenuItem();">
							<div class="row">
                      ...
                      <select class="select2 form-control" name="shop_id" required data-validation-required-message="This field is required">
                        ...
                        <?php endforeach; ?>
										...
										<div class="form-group" style="display:none">
											<label for="eventInput2">Is Offer Banner</label>
											<input type="text" id="eventInput2" class="form-control"   message="This field is required" placeholder="Offer Menu" value="1" name="is_offer_item">
										</div>
...
function addOfferMenuItem() {
  var form = $('form#formAddOfferMenu')[0];
  ...
  var regview;
     ...
     $.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>/welcome/addOfferMenuItem",
            data: data,
            async: false,
            cache: false,
            contentType: false,
