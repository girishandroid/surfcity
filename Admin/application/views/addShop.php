      ...
      <div class="content-wrapper">
        <div class="content-body">
          	...
          	<div class="row match-height">
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						<form class="form" id="formAddShop" action="javascript:addShopNew();">
							<div class="row">
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Select City</label>
                      <select class="select2 form-control"  name="shop_city"  required data-validation-required-message="This field is required" >
                        ...
                        <?php endforeach; ?>
										...
										<div class="form-group">
											...
											<input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Menu Item Name" name="owner_name">
										</div>
                    <div class="form-group">
											<label for="eventInput2">Shop Name</label>
											<input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Menu Item Name" name="shop_name">
										</div>
			...
			<div class="form-group">
                  		...
                  		<input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Delivery Charges" name="delivery_charges">
                	</div>							
                    <div class="form-group">
                      <label for="eventInput2">Opening to closing time</label>
                      <input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Menu Item Name" name="opening">
                    </div>

                    <div class="form-group">
									<label for="projectinput8">Shop Address</label>
									<textarea id="projectinput8" rows="3" class="form-control" name="shop_address" placeholder="About menu item"  required data-validation-required-message="This field is required"></textarea>
								</div>
                <div class="form-group">
                  <label for="eventInput2">Shop Landmark</label>
                  <input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Shop Landmark" name="shop_landmark">
                </div>

                <div class="form-group">
                  <label for="eventInput2">Shop Description</label>
                  <input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Menu Description" name="shop_desc">
                </div>
                <div class="form-group">
                  <label for="eventInput2">Shop Mobile</label>
                  <input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" placeholder="Menu Item Name" name="shop_phone">
                </div>
                <div class="form-group">
              <label for="eventInput2">Shop Mobile 2</label>
              <input type="text" id="eventInput2" class="form-control" required data-validation-required-message="This field is required" placeholder="Mobile Number" name="shop_phone2">
            </div>
            <div class="form-group">
              <label for="eventInput2">Comment</label>
              <input type="text" id="eventInput2" class="form-control" placeholder="Comment" name="comment">
            </div>
            <div class="form-group">
              <label for="eventInput2">Delivery Time</label>
              <input type="text" id="eventInput2" class="form-control" placeholder="Delivery Time" name="delivery_time">
            </div>
            <div class="form-group">
              <label for="eventInput2">Gst In (%)</label>
              <input type="number" id="eventInput2" class="form-control" placeholder="Gst In (%)" name="gst_per">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="eventInput2" class="form-control" placeholder="Latitude" name="lat">
            </div>
            <div class="form-group">
              <label for="eventInput2">Longitude</label>
              <input type="text" id="eventInput2" class="form-control" placeholder="Longitude" name="lng">
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="shop_email" placeholder="Email Address" data-validation-regex-regex="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" data-validation-regex-message="Enter Valid Email" aria-invalid="false">
                </div>
                  ...
                  <input type="file" id="file" name="file" class="custom-file-input" required data-validation-required-message="This field is required">
                    ...
                    <fieldset class="form-group">
                  <label for="file">Select Multiple Images of item(On Slider)</label>
                  <label class="custom-file center-block block">
                  <input type="file" id="filesUpload" name="userFiles[]" multiple="multiple" class="custom-file-input" required data-validation-required-message="This field is required">
                    <span class="custom-file-control"></span>
...
function addShopNew() {
  ...
  var regview;
     ...
     $.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>/welcome/addShopNew",
            data: data,
            async: false,
            cache: false,
            contentType: false,
