  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="basic-layout-form-center">Edit Menu Item</h4>
    ...
    <div class="card-body collapse in">
      <div class="card-block">
        ...
        <div class="card-text">
          <p>Change Item Data</p>
        </div>

        <form class="form" id="formEditMenu" action="javascript:updateMenuItem();">
          <div class="row">
            <div class="col-md-6 offset-md-3">
              <div class="form-body">
                <div class="form-group">
                  ...
                  <select class="select2 form-control" disabled required data-validation-required-message="This field is required">
                      ...
                      ?>
                      <?php if ($shop->owner_id = $menuItemList[0]->shop_id): ?>
                        <option selected value="<?php echo $shop->owner_id; ?>" ><?php echo $shop->shop_name; ?></option>
                      <?php else: ?>
                  ...
                  <select class="select2 form-control" name="shop_id" style="display:none">
                      <option value="">Select Shop</option>
                      <?php
                      foreach($shopList as $shop):
                      ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="eventInput2" class="form-control"  required data-validation-required-message="This field is required" value="<?php echo $menuItemList[0]->item_name ?>" placeholder="Menu Item Name" name="item_name">
                </div>

                <div class="form-group" style="display:none">
                  <label for="eventInput2">Menu Item Name</label>
                  <input type="text" id="eventInput2" class="form-control"  value="<?php echo $menuItemList[0]->item_id ?>" placeholder="Menu Item Name" name="item_id">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="select2 form-control"  name="item_category" required data-validation-required-message="This field is required">
                      ...
                      ?>
                      <?php if ($cate->id==$menuItemList[0]->item_category): ?>
                ...
                <div class="form-group">
                  ...
                  <select class="select2 form-control"  name="sub_food_category" required data-validation-required-message="This field is required">
                      ...
                      ?>
                      <?php if ($cate->id==$menuItemList[0]->sub_food_category): ?>
                        <option selected value="<?php echo $cate->id; ?>"  ><?php echo $cate->sub_cat_name; ?></option>
                      <?php else: ?>
              ...
              <textarea id="projectinput8" rows="3" class="form-control" name="item_desc" placeholder="About menu item"  required data-validation-required-message="This field is required"><?php echo $menuItemList[0]->item_desc ?></textarea>
            </div>

                <div class="form-group">
                  <label for="eventInput4">Item Price</label>
                  <input type="number" id="eventInput4" class="form-control" placeholder="Price" name="item_price" value="<?php echo $menuItemList[0]->item_price ?>" required data-validation-required-message="This field is required">
                </div>

                <div class="form-group">
                  <label for="eventInput5">Sell Price</label>
                  <input type="number" id="eventInput5" class="form-control" name="item_sellprice" value="<?php echo $menuItemList[0]->item_sellprice ?>"  required data-validation-required-message="This field is required" placeholder="Sell Price">
                </div>
                <div class="form-group">
              ...
              <input type="file" id="file" name="file" class="custom-file-input" >
                <span class="custom-file-control"></span>
                  ...
                  <img id="imageItem" name="imageItem" src="<?php echo base_url().$menuItemList[0]->image_path ?>"  required data-validation-required-message="This field is required" src="#" alt="your image" style="max-height:100px"/>
                </fieldset>
...
var form = $('form#formEditMenu')[0];

  var data = new FormData(form);

var regview;
var iditem = '<?php echo $menuItemList[0]->item_id ?>';

 $.ajax({
        type: "POST",
        url: "<?php echo site_url(); ?>/welcome/updateMenuItem",
        data: data,
        async: false,
        cache: false,
        contentType: false,
