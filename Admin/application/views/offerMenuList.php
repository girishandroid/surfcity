        ...
        <div class="col-xs-12">
            <div class="card" >
                <div class="card-header" >
                    <h4 class="card-title">Offer Menu Items List</h4>
                ...
                <div class="card-body collapse in" >
                    <div class="card-block card-dashboard" >
                        <p class="card-text">Offer Menu Of shops SURFCITY.</p>
                        <form id="formCity">
                          ...
                          <div class="form-group">
                              ...
                              <select class="select2-border border-warning form-control" onchange="changeOfferShop(this);" name="shop">
...
<!--get List Of Table-->
<script>
function changeOfferShop(obj){
  window.location.href = "<?php echo site_url(); ?>/welcome/offerMenus?shopId="+obj.value;
}
