                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        ...
                        <table class="table table-striped table-bordered "  style="width:100%">
                            ...
                            <tbody >
                            <?php foreach ($getOrderList as $val) {
                                $value = $val['orderDetails']; ?> <tr>
                                  <td>Coustomer  Name : <?php echo $value->user_fname;
                                                        $value->user_lname; ?><br>
                                  ...
                                  <td>Hotel Name : <?php echo $value->shop_name; ?><br>
                                      ...
                                      City : <?php
                                            foreach ($cityList as $city) :
                                                if ($value->shop_city == $city->id) echo $city->city_name;
                                            endforeach; ?><br></td>
                                 ...
                                 <tr>
                                 <td> <img  width="100" height="50" <?php if ($item->image_path) { ?> src="<?php echo base_url() . $item->image_path; ?>" <?php 
                                                                                                                                                    } ?> ></td>
